  ...
  return (
    <>
      ...
      <div className="flex gap-2 pt-4">
        <div className="relative xss:w-[46%] xsm:w-1/2 border-2 border-[#00FFBC] px-1 py-4 xl:px-2  shadow">
          <span className="absolute -top-3 left-2 bg-[#00FFBC] px-2 py-1  text-xs font-extrabold border-2 border-[#00FFBC] rounded-sm">
            tabby
          </span>
          <p className="font-alethia font-bold text-black flex flex-wrap items-center gap-1">
            Pay 4 interest-free payments of
            <span
              className="underline underline-offset-4 cursor-pointer text-black"
              onClick={() => setTabbyOpen(true)}
              aria-label="Learn more about Two Guys Interiors"
            >
              Learn more...
            </span>
          </p>
          <div className="flex flex-wrap lg:flex-nowrap justify-evenly gap-2 lg:gap-1 mt-2 font-inter">
            {paymentLabels.map((label, index) => (
              ...
              >
                <p className="text-xs font-bold font-alethia text-nowrap flex gap-1 items-center">
        ...
        <div className="relative xss:w-[46%] xsm:w-1/2 border-2 border-[#D47C84] px-1 py-4 xl:px-2 shadow">
          <span className="absolute -top-3 left-2 bg-linear-to-r from-blue-300 via-orange-300 to-pink-300 text-black font-extrabold px-2 py-1 border-2 border-[#D47C84] rounded-sm text-xs">
            tamara
          </span>
          <p className="font-alethia font-bold text-black flex flex-wrap items-center gap-1">
            Pay 4 interest-free payments of
      ...
      {/* Tabby Modal */}
      <Modal isOpen={tabbyOpen} onClose={() => setTabbyOpen(false)} width="w-[90%] sm:w-[60%]">
        <h2 className="text-2xl font-bold py-2">Easy Monthly Installments</h2>
        <div className="py-5 ps-2 sm:ps-10 md:ps-20 pe-4 me-4 xs:me-7 max-h-[90vh] custom-scroll">
      ...
      {/* Tamara Modal */}
      <Modal isOpen={tamaraOpen} onClose={() => setTamaraOpen(false)} width="w-[90%] sm:w-[60%]">
        <h2 className="text-2xl font-bold text-center">Pay easier with Tamara</h2>
        <div className="py-5 ps-2 sm:ps-10 md:ps-20 sm:pe-4 sm:me-4 max-h-[90vh] custom-scroll">
