...
export const HomeVideo: React.FC<HomeVideoProps> = ({ videoSrc, posterSrc, className = "" }) => {
  ...
  return (
    <div
      className={`relative w-full h-[300px] md:h-[400px] lg:h-[600px] overflow-hidden mt-10 ${className}`}
    >
      <video
        ref={videoRef}
