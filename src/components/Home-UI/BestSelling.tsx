              ...
              <div className="group bg-white shadow-sm hover:shadow-md transition-all relative overflow-hidden">
                ...
                <div className="p-4 group">
                  <div className="flex justify-between">
                    <Link href={item.link} className="text-[15px] font-normal font-alethia text-black">{item.title}</Link>
                  ...
                  <Link href="/collection" className="text-sm text-gray-400">{item.category}</Link>
