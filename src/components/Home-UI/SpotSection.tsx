...
export const SpotSection = ({ height, imageUrl }: { height: string; imageUrl: string }) => {
    ...
    return (
        <div className={` relative w-full ${height}`}>
            ...
            {Spots.map((spot) => (
                ...
                <div
                    className={`absolute 
                        top-[-120%] left-[50%] translate-x-[-50%]   
                        md:top-[-90%] md:left-[110%] md:translate-x-0   
                        lg:left-[120%] lg:w-[115px]                   
                ...
                <Link href={spot.link} className="border-s border-[#E1E1E1] flex justify-center items-center">
